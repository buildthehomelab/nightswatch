...
import { useTrueNas, nasIssues, fmtUptime, UI as NAS_UI, POOL_WARN_PCT, POOL_CRIT_PCT } from './components/TrueNas';
import {
        ...
        {isHealthy ? (
          ...
          <>
            <div className="masthead">
              <div className="eyebrow rise">{mastheadEyebrow(issues)}</div>
