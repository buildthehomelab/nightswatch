...
function Ambient({ now, wanUp, uptime, weather, showWeather, showWan, showUptime, showNas, showNasName, showNasLoad, showNasApps, showNasPools, showDate, placement, nasData }) {
