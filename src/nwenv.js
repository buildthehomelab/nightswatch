...
export const SANDBOX_LEFT_URL     = str ('SANDBOX_LEFT_URL',         import.meta.env.VITE_SANDBOX_LEFT_URL);
export const SANDBOX_RIGHT_URL    = str ('SANDBOX_RIGHT_URL',        import.meta.env.VITE_SANDBOX_RIGHT_URL);
